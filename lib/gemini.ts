...
//   const prompt = `You are an expert teacher who suggests excellent outstanding videos based on "${topic}". Generate 5 YouTube search phrases to learn the topic from beginner to advanced,the videos should be from famous channels and not shorts videos. Return only a JSON array of strings.`;
