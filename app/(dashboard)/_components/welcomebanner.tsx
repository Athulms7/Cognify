...
function WelcomeBanner({session}:any) {
  ...
  return (
    <div
      className={`w-full p-8 bg-gradient-to-br from-primary via-black to-primary/80 dark:from-primary/90 dark:to-primary/80 rounded-3xl shadow-xl transition-all duration-700  transform ${
