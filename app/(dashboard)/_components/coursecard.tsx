...
export default function CreateCourseCard() {
  return (
    <Link href={"/create"}>
    <div className="border border-dashed border-gray-500 rounded-xl p-6 flex flex-col items-center justify-center text-center bg-black text-white min-h-[300px]">
